...
```{python echo=FALSE}
# Secuencia de DNA
dna = 'AAGGAUGTCGCGCGTTATTAGCCTAAUAA'
...
print('El codon AUG empieza en la posicion: ',inicio)
...
# Cortar la secuencia 
mrna = dna[inicio:fin]
print('El codon AUG empieza en la posicion ',inicio, ' y termina en ',fin)
print(f'\nFragmento de RNA transcrito {met_ini}: \n{mrna}')
...
.content-box-blue[
¿Cuantas `A`, `T`, `C` y `G` hay en la secuencia
